-- ============================================================
-- AIRA Security Enforcement Foundation
-- Migration: V6
-- PostgreSQL: 17
-- ============================================================
...
COMMENT ON TABLE aira_security.api_key_access_policy IS 'API key path-level access policies for protected AIRA APIs.';
COMMENT ON TABLE aira_security.api_security_audit_event IS 'Audit events for API security allow, deny, and public decisions.';