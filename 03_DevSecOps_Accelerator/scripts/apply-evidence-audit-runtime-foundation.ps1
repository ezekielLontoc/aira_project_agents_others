...
$SqlFiles = @(
    "$AccelRoot\database\migrations\V8__aira_evidence_audit_runtime_foundation.sql",
    "$AccelRoot\database\seed\V9__aira_evidence_audit_runtime_seed.sql"
)
...
Write-Host "Evidence and audit runtime foundation SQL applied successfully." -ForegroundColor Green