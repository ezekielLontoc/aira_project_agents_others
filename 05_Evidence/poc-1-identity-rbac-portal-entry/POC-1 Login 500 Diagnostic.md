...
java.lang.IllegalArgumentException: Name for argument of type [java.util.UUID] not specified, and parameter name information not available via reflection. Ensure that the compiler uses the '-parameters' flag.
	...
	at org.springframework.boot.web.servlet.support.ErrorPageFilter.doFilter(ErrorPageFilter.java:117) ~[spring-boot-3.5.0.jar:3.5.0]
	at org.apache.catalina.valves.ErrorReportValve.invoke(ErrorReportValve.java:83) ~[catalina.jar:11.0.22]
java.lang.IllegalStateException: java.nio.file.NoSuchFileException: /usr/local/tomcat/webapps/ROOT/WEB-INF/lib/jackson-databind-2.19.0.jar
Caused by: java.nio.file.NoSuchFileException: /usr/local/tomcat/webapps/ROOT/WEB-INF/lib/jackson-databind-2.19.0.jar
	at java.base/sun.nio.fs.UnixException.translateToIOException(UnixException.java:92)
	at java.base/sun.nio.fs.UnixException.rethrowAsIOException(UnixException.java:106)
	at java.base/sun.nio.fs.UnixException.rethrowAsIOException(UnixException.java:111)
2026-06-15T09:18:53.350Z ERROR 1 --- [accelerator-security] [nio-8080-exec-8] o.s.b.w.servlet.support.ErrorPageFilter  : Forwarding to error page from request [/api/v1/identity/login] due to exception [class java.sql.Timestamp cannot be cast to class java.time.OffsetDateTime (java.sql.Timestamp is in module java.sql of loader 'platform'; java.time.OffsetDateTime is in module java.base of loader 'bootstrap')]
java.lang.ClassCastException: class java.sql.Timestamp cannot be cast to class java.time.OffsetDateTime (java.sql.Timestamp is in module java.sql of loader 'platform'; java.time.OffsetDateTime is in module java.base of loader 'bootstrap')
	at com.aira.accelerator.security.identity.IdentityService.loadSession(IdentityService.java:579) ~[classes/:na]
	at com.aira.accelerator.security.identity.IdentityService.sessionContext(IdentityService.java:345) ~[classes/:na]
	at com.aira.accelerator.security.identity.IdentityService.login(IdentityService.java:316) ~[classes/:na]
	at com.aira.accelerator.security.identity.IdentityService$$SpringCGLIB$$0.login(<generated>) ~[classes/:na]
	at com.aira.accelerator.security.identity.IdentityController.login(IdentityController.java:39) ~[classes/:na]
	at org.springframework.boot.web.servlet.support.ErrorPageFilter.doFilter(ErrorPageFilter.java:124) ~[spring-boot-3.5.0.jar:3.5.0]
	at org.springframework.boot.web.servlet.support.ErrorPageFilter$1.doFilterInternal(ErrorPageFilter.java:99) ~[spring-boot-3.5.0.jar:3.5.0]
	at org.springframework.boot.web.servlet.support.ErrorPageFilter.doFilter(ErrorPageFilter.java:117) ~[spring-boot-3.5.0.jar:3.5.0]
	at org.apache.catalina.valves.ErrorReportValve.invoke(ErrorReportValve.java:83) ~[catalina.jar:11.0.22]
2026-06-15T09:23:29.158Z ERROR 1 --- [accelerator-security] [nio-8080-exec-7] o.s.b.w.servlet.support.ErrorPageFilter  : Forwarding to error page from request [/api/v1/identity/login] due to exception [class java.sql.Timestamp cannot be cast to class java.time.OffsetDateTime (java.sql.Timestamp is in module java.sql of loader 'platform'; java.time.OffsetDateTime is in module java.base of loader 'bootstrap')]
java.lang.ClassCastException: class java.sql.Timestamp cannot be cast to class java.time.OffsetDateTime (java.sql.Timestamp is in module java.sql of loader 'platform'; java.time.OffsetDateTime is in module java.base of loader 'bootstrap')
	at com.aira.accelerator.security.identity.IdentityService.loadSession(IdentityService.java:579) ~[classes/:na]
	at com.aira.accelerator.security.identity.IdentityService.sessionContext(IdentityService.java:345) ~[classes/:na]
	at com.aira.accelerator.security.identity.IdentityService.login(IdentityService.java:316) ~[classes/:na]
...
15-Jun-2026 09:18:42.756 INFO [Thread-2] org.apache.coyote.AbstractProtocol.pause Pausing ProtocolHandler ["http-nio-8080"]
15-Jun-2026 09:18:42.760 INFO [Thread-2] org.apache.catalina.core.StandardService.stopInternal Stopping service [Catalina]
java.lang.IllegalStateException: java.nio.file.NoSuchFileException: /usr/local/tomcat/webapps/ROOT/WEB-INF/lib/jackson-databind-2.19.0.jar
	...
	at org.apache.catalina.webresources.AbstractArchiveResourceSet.getResource(AbstractArchiveResourceSet.java:281)
	at org.apache.catalina.webresources.StandardRoot.getResourceInternal(StandardRoot.java:273)
	...
	at org.apache.catalina.webresources.StandardRoot.getClassLoaderResource(StandardRoot.java:221)
	at org.apache.catalina.loader.WebappClassLoaderBase.findClassInternal(WebappClassLoaderBase.java:2065)
	at org.apache.catalina.loader.WebappClassLoaderBase.findClass(WebappClassLoaderBase.java:693)
	at org.apache.catalina.loader.WebappClassLoaderBase.loadClass(WebappClassLoaderBase.java:1186)
	at org.apache.catalina.loader.WebappClassLoaderBase.loadClass(WebappClassLoaderBase.java:1056)
	at io.micrometer.core.instrument.binder.jvm.JvmGcMetrics$GcMetricsNotificationListener.isMajorGenerationalGc(JvmGcMetrics.java:276)
	at io.micrometer.core.instrument.binder.jvm.JvmGcMetrics$GcMetricsNotificationListener.shouldUpdateDataSizeMetrics(JvmGcMetrics.java:272)
	at io.micrometer.core.instrument.binder.jvm.JvmGcMetrics$GcMetricsNotificationListener.handleNotification(JvmGcMetrics.java:238)
...
Caused by: java.nio.file.NoSuchFileException: /usr/local/tomcat/webapps/ROOT/WEB-INF/lib/jackson-databind-2.19.0.jar
	...
	at org.apache.catalina.webresources.AbstractArchiveResourceSet.openJarFile(AbstractArchiveResourceSet.java:367)
	...
	... 14 more
15-Jun-2026 09:18:42.778 WARNING [Thread-2] org.apache.catalina.loader.WebappClassLoaderBase.clearReferencesThreads The web application [ROOT] appears to have started a thread named [accelerator-security-pool:housekeeper] but has failed to stop it. This is very likely to create a memory leak. Stack trace of thread:
 java.base/jdk.internal.misc.Unsafe.park(Native Method)
 java.base/java.util.concurrent.locks.LockSupport.parkNanos(LockSupport.java:269)
 java.base/java.util.concurrent.locks.AbstractQueuedSynchronizer$ConditionObject.awaitNanos(AbstractQueuedSynchronizer.java:1797)
 java.base/java.util.concurrent.ScheduledThreadPoolExecutor$DelayedWorkQueue.take(ScheduledThreadPoolExecutor.java:1182)
 ...
 java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:642)
 java.base/java.lang.Thread.run(Thread.java:1583)
15-Jun-2026 09:18:42.797 INFO [Thread-2] org.apache.coyote.AbstractProtocol.stop Stopping ProtocolHandler ["http-nio-8080"]
15-Jun-2026 09:18:42.804 INFO [Thread-2] org.apache.coyote.AbstractProtocol.destroy Destroying ProtocolHandler ["http-nio-8080"]
15-Jun-2026 09:18:43.871 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Server version name:   Apache Tomcat/11.0.22
15-Jun-2026 09:18:43.876 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Server built:          May 1 2026 18:29:05 UTC
15-Jun-2026 09:18:43.877 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Server version number: 11.0.22.0
15-Jun-2026 09:18:43.877 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log OS Name:               Linux
15-Jun-2026 09:18:43.877 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log OS Version:            6.6.87.2-microsoft-standard-WSL2
15-Jun-2026 09:18:43.877 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Architecture:          amd64
15-Jun-2026 09:18:43.877 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Java Home:             /opt/java/openjdk
15-Jun-2026 09:18:43.877 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log JVM Version:           21.0.11+10-LTS
15-Jun-2026 09:18:43.877 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log JVM Vendor:            Eclipse Adoptium
15-Jun-2026 09:18:43.877 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log CATALINA_BASE:         /usr/local/tomcat
15-Jun-2026 09:18:43.878 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log CATALINA_HOME:         /usr/local/tomcat
15-Jun-2026 09:18:43.892 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: -Djava.util.logging.config.file=/usr/local/tomcat/conf/logging.properties
15-Jun-2026 09:18:43.892 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: -Djava.util.logging.manager=org.apache.juli.ClassLoaderLogManager
15-Jun-2026 09:18:43.892 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: -Djdk.tls.ephemeralDHKeySize=2048
15-Jun-2026 09:18:43.892 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: -Dorg.apache.catalina.security.SecurityListener.UMASK=0027
15-Jun-2026 09:18:43.893 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: --add-opens=java.base/java.lang=ALL-UNNAMED
15-Jun-2026 09:18:43.893 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: --add-opens=java.base/java.lang.reflect=ALL-UNNAMED
15-Jun-2026 09:18:43.893 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: --add-opens=java.base/java.io=ALL-UNNAMED
15-Jun-2026 09:18:43.893 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: --add-opens=java.base/java.util=ALL-UNNAMED
15-Jun-2026 09:18:43.894 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: --add-opens=java.base/java.util.concurrent=ALL-UNNAMED
15-Jun-2026 09:18:43.894 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: --add-opens=java.rmi/sun.rmi.transport=ALL-UNNAMED
15-Jun-2026 09:18:43.894 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: --enable-native-access=ALL-UNNAMED
15-Jun-2026 09:18:43.894 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: -Dcatalina.base=/usr/local/tomcat
15-Jun-2026 09:18:43.894 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: -Dcatalina.home=/usr/local/tomcat
15-Jun-2026 09:18:43.894 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: -Djava.io.tmpdir=/usr/local/tomcat/temp
15-Jun-2026 09:18:43.902 INFO [main] org.apache.catalina.core.AprLifecycleListener.lifecycleEvent Loaded Apache Tomcat Native library [2.0.14] using APR version [1.7.2].
15-Jun-2026 09:18:43.909 INFO [main] org.apache.catalina.core.AprLifecycleListener.initializeSSL OpenSSL successfully initialized [OpenSSL 3.0.13 30 Jan 2024]
15-Jun-2026 09:18:44.167 INFO [main] org.apache.coyote.AbstractProtocol.init Initializing ProtocolHandler ["http-nio-8080"]
15-Jun-2026 09:18:44.195 INFO [main] org.apache.catalina.startup.Catalina.load Server initialization in [528] milliseconds
15-Jun-2026 09:18:44.239 INFO [main] org.apache.catalina.core.StandardService.startInternal Starting service [Catalina]
15-Jun-2026 09:18:44.239 INFO [main] org.apache.catalina.core.StandardEngine.startInternal Starting Servlet engine: [Apache Tomcat/11.0.22]
15-Jun-2026 09:18:44.255 INFO [main] org.apache.catalina.startup.HostConfig.deployWAR Deploying web application archive [/usr/local/tomcat/webapps/ROOT.war]
15-Jun-2026 09:18:45.516 INFO [main] org.apache.jasper.servlet.TldScanner.scanJars At least one JAR was scanned for TLDs yet contained no TLDs. Enable debug logging for this logger for a complete list of JARs that were scanned but no TLDs were found in them. Skipping unneeded JARs during scanning can improve startup time and JSP compilation time.
...
2026-06-15T09:18:46.062Z  INFO 1 --- [accelerator-security] [           main] a.a.s.AiraAcceleratorSecurityApplication : Starting AiraAcceleratorSecurityApplication using Java 21.0.11 with PID 1 (/usr/local/tomcat/webapps/ROOT/WEB-INF/classes started by root in /usr/local/tomcat)
2026-06-15T09:18:46.064Z  INFO 1 --- [accelerator-security] [           main] a.a.s.AiraAcceleratorSecurityApplication : The following 1 profile is active: "default"
2026-06-15T09:18:46.908Z  INFO 1 --- [accelerator-security] [           main] w.s.c.ServletWebServerApplicationContext : Root WebApplicationContext: initialization completed in 826 ms
2026-06-15T09:18:47.947Z  INFO 1 --- [accelerator-security] [           main] o.s.b.a.e.web.EndpointLinksResolver      : Exposing 2 endpoints beneath base path '/actuator'
2026-06-15T09:18:48.016Z  INFO 1 --- [accelerator-security] [           main] a.a.s.AiraAcceleratorSecurityApplication : Started AiraAcceleratorSecurityApplication in 2.367 seconds (process running for 4.586)
15-Jun-2026 09:18:48.051 INFO [main] org.apache.catalina.startup.HostConfig.deployWAR Deployment of web application archive [/usr/local/tomcat/webapps/ROOT.war] has finished in [3,795] ms
15-Jun-2026 09:18:48.053 INFO [main] org.apache.coyote.AbstractProtocol.start Starting ProtocolHandler ["http-nio-8080"]
15-Jun-2026 09:18:48.062 INFO [main] org.apache.catalina.startup.Catalina.start Server startup in [3866] milliseconds
2026-06-15T09:18:51.659Z  INFO 1 --- [accelerator-security] [nio-8080-exec-1] o.s.web.servlet.DispatcherServlet        : Initializing Servlet 'dispatcherServlet'
2026-06-15T09:18:51.660Z  INFO 1 --- [accelerator-security] [nio-8080-exec-1] o.s.web.servlet.DispatcherServlet        : Completed initialization in 1 ms
2026-06-15T09:18:51.694Z  INFO 1 --- [accelerator-security] [nio-8080-exec-1] com.zaxxer.hikari.HikariDataSource       : accelerator-security-pool - Starting...
2026-06-15T09:18:51.706Z  INFO 1 --- [accelerator-security] [nio-8080-exec-1] com.zaxxer.hikari.HikariDataSource       : accelerator-security-pool - Start completed.
2026-06-15T09:18:53.350Z ERROR 1 --- [accelerator-security] [nio-8080-exec-8] o.s.b.w.servlet.support.ErrorPageFilter  : Forwarding to error page from request [/api/v1/identity/login] due to exception [class java.sql.Timestamp cannot be cast to class java.time.OffsetDateTime (java.sql.Timestamp is in module java.sql of loader 'platform'; java.time.OffsetDateTime is in module java.base of loader 'bootstrap')]
...
15-Jun-2026 09:23:18.308 INFO [Thread-2] org.apache.coyote.AbstractProtocol.pause Pausing ProtocolHandler ["http-nio-8080"]
15-Jun-2026 09:23:18.310 INFO [Thread-2] org.apache.catalina.core.StandardService.stopInternal Stopping service [Catalina]
15-Jun-2026 09:23:18.310 INFO [Catalina-utility-2] org.apache.catalina.startup.HostConfig.undeploy Undeploying context []
15-Jun-2026 09:23:18.316 WARNING [Catalina-utility-2] org.apache.catalina.loader.WebappClassLoaderBase.clearReferencesThreads The web application [ROOT] appears to have started a thread named [accelerator-security-pool:housekeeper] but has failed to stop it. This is very likely to create a memory leak. Stack trace of thread:
 java.base/jdk.internal.misc.Unsafe.park(Native Method)
 java.base/java.util.concurrent.locks.LockSupport.parkNanos(LockSupport.java:269)
 java.base/java.util.concurrent.locks.AbstractQueuedSynchronizer$ConditionObject.awaitNanos(AbstractQueuedSynchronizer.java:1797)
 java.base/java.util.concurrent.ScheduledThreadPoolExecutor$DelayedWorkQueue.take(ScheduledThreadPoolExecutor.java:1182)
 ...
 java.base/java.util.concurrent.ThreadPoolExecutor$Worker.run(ThreadPoolExecutor.java:642)
 java.base/java.lang.Thread.run(Thread.java:1583)
15-Jun-2026 09:23:18.326 INFO [Catalina-utility-2] org.apache.catalina.startup.HostConfig.deployWAR Deploying web application archive [/usr/local/tomcat/webapps/ROOT.war]
15-Jun-2026 09:23:19.056 INFO [Catalina-utility-2] org.apache.jasper.servlet.TldScanner.scanJars At least one JAR was scanned for TLDs yet contained no TLDs. Enable debug logging for this logger for a complete list of JARs that were scanned but no TLDs were found in them. Skipping unneeded JARs during scanning can improve startup time and JSP compilation time.
15-Jun-2026 09:23:20.175 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Server version name:   Apache Tomcat/11.0.22
15-Jun-2026 09:23:20.180 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Server built:          May 1 2026 18:29:05 UTC
15-Jun-2026 09:23:20.180 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Server version number: 11.0.22.0
15-Jun-2026 09:23:20.180 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log OS Name:               Linux
15-Jun-2026 09:23:20.180 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log OS Version:            6.6.87.2-microsoft-standard-WSL2
15-Jun-2026 09:23:20.181 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Architecture:          amd64
15-Jun-2026 09:23:20.181 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Java Home:             /opt/java/openjdk
15-Jun-2026 09:23:20.181 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log JVM Version:           21.0.11+10-LTS
15-Jun-2026 09:23:20.181 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log JVM Vendor:            Eclipse Adoptium
15-Jun-2026 09:23:20.181 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log CATALINA_BASE:         /usr/local/tomcat
15-Jun-2026 09:23:20.182 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log CATALINA_HOME:         /usr/local/tomcat
15-Jun-2026 09:23:20.195 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: -Djava.util.logging.config.file=/usr/local/tomcat/conf/logging.properties
15-Jun-2026 09:23:20.195 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: -Djava.util.logging.manager=org.apache.juli.ClassLoaderLogManager
15-Jun-2026 09:23:20.195 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: -Djdk.tls.ephemeralDHKeySize=2048
15-Jun-2026 09:23:20.195 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: -Dorg.apache.catalina.security.SecurityListener.UMASK=0027
15-Jun-2026 09:23:20.195 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: --add-opens=java.base/java.lang=ALL-UNNAMED
15-Jun-2026 09:23:20.196 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: --add-opens=java.base/java.lang.reflect=ALL-UNNAMED
15-Jun-2026 09:23:20.196 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: --add-opens=java.base/java.io=ALL-UNNAMED
15-Jun-2026 09:23:20.196 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: --add-opens=java.base/java.util=ALL-UNNAMED
15-Jun-2026 09:23:20.196 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: --add-opens=java.base/java.util.concurrent=ALL-UNNAMED
15-Jun-2026 09:23:20.196 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: --add-opens=java.rmi/sun.rmi.transport=ALL-UNNAMED
15-Jun-2026 09:23:20.196 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: --enable-native-access=ALL-UNNAMED
15-Jun-2026 09:23:20.196 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: -Dcatalina.base=/usr/local/tomcat
15-Jun-2026 09:23:20.196 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: -Dcatalina.home=/usr/local/tomcat
15-Jun-2026 09:23:20.197 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Command line argument: -Djava.io.tmpdir=/usr/local/tomcat/temp
15-Jun-2026 09:23:20.201 INFO [main] org.apache.catalina.core.AprLifecycleListener.lifecycleEvent Loaded Apache Tomcat Native library [2.0.14] using APR version [1.7.2].
15-Jun-2026 09:23:20.205 INFO [main] org.apache.catalina.core.AprLifecycleListener.initializeSSL OpenSSL successfully initialized [OpenSSL 3.0.13 30 Jan 2024]
15-Jun-2026 09:23:20.459 INFO [main] org.apache.coyote.AbstractProtocol.init Initializing ProtocolHandler ["http-nio-8080"]
15-Jun-2026 09:23:20.482 INFO [main] org.apache.catalina.startup.Catalina.load Server initialization in [475] milliseconds
15-Jun-2026 09:23:20.515 INFO [main] org.apache.catalina.core.StandardService.startInternal Starting service [Catalina]
15-Jun-2026 09:23:20.515 INFO [main] org.apache.catalina.core.StandardEngine.startInternal Starting Servlet engine: [Apache Tomcat/11.0.22]
15-Jun-2026 09:23:20.528 INFO [main] org.apache.catalina.startup.HostConfig.deployWAR Deploying web application archive [/usr/local/tomcat/webapps/ROOT.war]
15-Jun-2026 09:23:21.433 INFO [main] org.apache.jasper.servlet.TldScanner.scanJars At least one JAR was scanned for TLDs yet contained no TLDs. Enable debug logging for this logger for a complete list of JARs that were scanned but no TLDs were found in them. Skipping unneeded JARs during scanning can improve startup time and JSP compilation time.
...
2026-06-15T09:23:21.957Z  INFO 1 --- [accelerator-security] [           main] a.a.s.AiraAcceleratorSecurityApplication : Starting AiraAcceleratorSecurityApplication using Java 21.0.11 with PID 1 (/usr/local/tomcat/webapps/ROOT/WEB-INF/classes started by root in /usr/local/tomcat)
2026-06-15T09:23:21.958Z  INFO 1 --- [accelerator-security] [           main] a.a.s.AiraAcceleratorSecurityApplication : The following 1 profile is active: "default"
2026-06-15T09:23:22.720Z  INFO 1 --- [accelerator-security] [           main] w.s.c.ServletWebServerApplicationContext : Root WebApplicationContext: initialization completed in 744 ms
2026-06-15T09:23:23.626Z  INFO 1 --- [accelerator-security] [           main] o.s.b.a.e.web.EndpointLinksResolver      : Exposing 2 endpoints beneath base path '/actuator'
2026-06-15T09:23:23.694Z  INFO 1 --- [accelerator-security] [           main] a.a.s.AiraAcceleratorSecurityApplication : Started AiraAcceleratorSecurityApplication in 2.142 seconds (process running for 3.907)
15-Jun-2026 09:23:23.743 INFO [main] org.apache.catalina.startup.HostConfig.deployWAR Deployment of web application archive [/usr/local/tomcat/webapps/ROOT.war] has finished in [3,214] ms
15-Jun-2026 09:23:23.746 INFO [main] org.apache.coyote.AbstractProtocol.start Starting ProtocolHandler ["http-nio-8080"]
15-Jun-2026 09:23:23.756 INFO [main] org.apache.catalina.startup.Catalina.start Server startup in [3273] milliseconds
2026-06-15T09:23:27.970Z  INFO 1 --- [accelerator-security] [nio-8080-exec-1] o.s.web.servlet.DispatcherServlet        : Initializing Servlet 'dispatcherServlet'
2026-06-15T09:23:27.971Z  INFO 1 --- [accelerator-security] [nio-8080-exec-1] o.s.web.servlet.DispatcherServlet        : Completed initialization in 1 ms
2026-06-15T09:23:28.003Z  INFO 1 --- [accelerator-security] [nio-8080-exec-1] com.zaxxer.hikari.HikariDataSource       : accelerator-security-pool - Starting...
2026-06-15T09:23:28.017Z  INFO 1 --- [accelerator-security] [nio-8080-exec-1] com.zaxxer.hikari.HikariDataSource       : accelerator-security-pool - Start completed.
2026-06-15T09:23:29.158Z ERROR 1 --- [accelerator-security] [nio-8080-exec-7] o.s.b.w.servlet.support.ErrorPageFilter  : Forwarding to error page from request [/api/v1/identity/login] due to exception [class java.sql.Timestamp cannot be cast to class java.time.OffsetDateTime (java.sql.Timestamp is in module java.sql of loader 'platform'; java.time.OffsetDateTime is in module java.base of loader 'bootstrap')]
...
Login still returns HTTP 500. Do not begin Phase 3 until the exact login exception is repaired and the full runtime flow returns /portal/developer-dashboard.html.